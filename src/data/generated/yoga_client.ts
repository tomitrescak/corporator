...
export interface Query {
  ...
  bpmnProcesses: <T = BpmnProcess[]>(
    args: { input: BpmnProcessesInput },
    info?: GraphQLResolveInfo | string,
    options?: Options
  ) => Promise<T>;
  bpmnProcessInstances: <T = BpmnProcessInstance[]>(
    args: { input: BpmnProcessInstancesInput },
    info?: GraphQLResolveInfo | string,
    options?: Options
  ) => Promise<T>;
  bpmnTasks: <T = BpmnTaskInstance[]>(
    args: { input: BpmnTasksInput },
    info?: GraphQLResolveInfo | string,
    options?: Options
  ) => Promise<T>;
  user: <T = User | null>(
...
export interface Mutation {
  ...
  createProcess: <T = BpmnProcess | null>(
    args: { input: CreateProcessInput },
    info?: GraphQLResolveInfo | string,
    options?: Options
  ) => Promise<T>;
  createProcessInstance: <T = BpmnProcessInstance | null>(
    args: { input: CreateProcessInstanceInput },
    info?: GraphQLResolveInfo | string,
    options?: Options
  ) => Promise<T>;
  login: <T = AuthPayload>(
...
export type ProcessStatus = 'Draft' | 'Proposal' | 'Published';
...
export type ResourceType = 'Url' | 'File' | 'Form' | 'Report';
...
export type DataType = 'Id' | 'Boolean' | 'Float' | 'Int' | 'String' | 'Date' | 'Object';
...
export type AccessConditionOrderByInput =
  | 'organisationId_ASC'
  | 'organisationId_DESC'
  | 'roleId_ASC'
  | 'roleId_DESC'
...
export type DataDescriptorOrderByInput =
  | 'id_ASC'
  | 'id_DESC'
  | 'defaultValue_ASC'
  | 'defaultValue_DESC'
...
export type BpmnTaskInstanceOrderByInput =
  | 'id_ASC'
  | 'id_DESC'
  | 'dateFinished_ASC'
  | 'dateFinished_DESC'
...
export type BpmnProcessOrderByInput =
  | 'id_ASC'
  | 'id_DESC'
  | 'actionCount_ASC'
  | 'actionCount_DESC'
