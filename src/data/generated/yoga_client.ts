...
export interface Mutation {
    ...
    setProcessInstanceStatus: <T = BpmnProcessInstanceOutput>(args: { input: SetProcessInstanceStatusInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    createTaskInstance: <T = BpmnTaskInstance>(args: { input: CreateTaskInstanceInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    ...
    submitForm: <T = BpmnTaskInstance>(args: { input: SubmitFormInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
