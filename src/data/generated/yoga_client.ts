...
export interface Query {
    testQuery: <T = Boolean>(args?: {}, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    notificationsQuery: <T = Notification[]>(args: { input?: NotificationsInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    bpmnProcessesQuery: <T = BpmnProcess[]>(args: { input: BpmnProcessesInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    bpmnProcessQuery: <T = BpmnProcess>(args: { id: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    bpmnProcessInstanceQuery: <T = BpmnProcessInstance>(args: { id: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    ...
    userQuery: <T = User>(args: { id: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    ...
    resourceQuery: <T = Resource>(args: { id: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    processResourceQuery: <T = Resource>(args: { id: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> 
  }

export interface Mutation {
    testMutation: <T = Boolean>(args?: {}, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    reset: <T = Boolean>(args?: {}, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    notify: <T = Notification>(args: { input?: NotifyInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    removeNotification: <T = String>(args: { id?: String }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    clearNotifications: <T = Boolean>(args?: {}, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    createProcess: <T = BpmnProcess>(args: { input: CreateProcessInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    launchProcessInstance: <T = BpmnProcessInstanceOutput>(args: { input: LaunchProcessInstanceInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    duplicateProcessInstance: <T = BpmnProcessInstanceOutput>(args: { input: DuplicateProcessInstanceInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    abortProcessInstance: <T = BpmnProcessInstance>(args: { input: AbortProcessInstanceInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    pauseProcessInstance: <T = BpmnProcessInstance>(args: { input: PauseProcessInstanceInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    addComment: <T = BpmnProcessInstance>(args: { input: AddCommentInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    updateTaskInstanceStatus: <T = BpmnTaskInstance>(args: { input: UpdateTaskInstanceStatusInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    submitTask: <T = BpmnTaskInstance>(args: { input: SubmitTaskInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    saveForm: <T = BpmnTaskInstance>(args: { input: SaveFormInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
...
export interface PauseProcessInstanceInput {
...
export interface AbortProcessInstanceInput {
  processInstanceId: String
}
